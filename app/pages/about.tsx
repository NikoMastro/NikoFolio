  ...
  return (
    <Layout>
      <div className="p-8 max-w-4xl mx-auto">
        ...
        <p className="text-lg">
          When I’m not coding, you can find me exploring new technologies, contributing to open-source projects, or enjoying some creative pursuits like digital art.
        </p>
      </div>
    </Layout>
  );
